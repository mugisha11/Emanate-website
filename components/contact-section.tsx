    ...
    <section id="contact" className="py-20 lg:py-32 bg-white">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-5xl font-bold text-foreground mb-6">Contact Us</h2>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed mb-8">
                We welcome inquiries from researchers, policymakers, organizations, and community members interested in
                evidence-based solutions for population and family development.
              </p>
            </div>
